    ...
    <SideBarContainerCSS>
      ...
      <div className="campaign-sidemenu">
        <div className="campaign-sidemenu-company-box">
          <span className="campaign-sidemenu-company-name">
        ...
        {showProfileInfo && (
          <div className="btn-menus">
            <div className="btn-menu" onClick={campaignHandle}>
              캠페인
            </div>
            <div className="btn-menu" onClick={handleLogout}>
              로그아웃
            </div>
          </div>
        )}
...
const SideBarContainerCSS = styled.div`
  ...
  align-items: center;
  box-shadow: 1px 0px 10px rgb(0 0 0 / 7%);
  .campaign-logo {
    padding-top: 20px;
    img {
      height: 43px;
